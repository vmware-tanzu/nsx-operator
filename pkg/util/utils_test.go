...
func TestNormalizeId(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			want: "k8scl-one_12345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901-e8ad9afc",
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func TestGenerateIDByObject(t *testing.T) {
	for _, tc := range []struct {
		...
		},
		{
			...
			expID: fmt.Sprintf("%s_q3qpx", strings.Repeat("a", 144)),
		},
	} {
