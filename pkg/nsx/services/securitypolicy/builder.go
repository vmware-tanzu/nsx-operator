...
func (service *Service) buildSecurityPolicy(obj *v1alpha1.SecurityPolicy) (*model.SecurityPolicy, *[]model.Group, error) {
...
func (service *Service) buildPolicyGroup(obj *v1alpha1.SecurityPolicy) (*model.Group, string, error) {
...
func (service Service) buildTargetTags(obj *v1alpha1.SecurityPolicy, targets *[]v1alpha1.SecurityPolicyTarget, idx int) []model.Tag {
...
func (service *Service) buildBasicTags(obj *v1alpha1.SecurityPolicy) []model.Tag {
	uid := string(obj.UID)
	clusterTag := service.NSXConfig.Cluster
...
func (service Service) buildConjOperator(op string) *data.StructValue {
...
func (service Service) buildGroupExpression(policyExpression *[]*data.StructValue) *data.ListValue {
...
func (service Service) buildExpression(resource_type, member_type, value, key, operator, scope_op string) *data.StructValue {
...
func (service *Service) buildExpressionsMatchExpression(matchExpressions []v1.LabelSelectorRequirement, memberType string, expressions *data.ListValue) error {
	var err error = nil
	errorMsg := ""
...
func (service Service) buildPolicyGroupID(obj *v1alpha1.SecurityPolicy) string {
	return fmt.Sprintf("sp_%s_scope", obj.UID)
}

func (service Service) buildPolicyGroupPath(obj *v1alpha1.SecurityPolicy) string {
	policyGroupID := service.buildPolicyGroupID(obj)
	return fmt.Sprintf("/infra/domains/%s/groups/%s", service.NSXConfig.Cluster, policyGroupID)
}

func (service *Service) buildRuleAndGroups(obj *v1alpha1.SecurityPolicy, rule *v1alpha1.SecurityPolicyRule, ruleIdx int) ([]*model.Rule, []*model.Group, error) {
...
func (service *Service) buildRuleServiceEntries(port v1alpha1.SecurityPolicyPort, portAddress util2.PortAddress) *data.StructValue {
...
func (service *Service) buildRuleAppliedToGroup(obj *v1alpha1.SecurityPolicy, rule *v1alpha1.SecurityPolicyRule, ruleIdx int, nsxRuleSrcGroupPath string, nsxRuleDstGroupPath string) (*model.Group, string, error) {
	var nsxRuleAppliedGroup *model.Group
	var nsxRuleAppliedGroupPath string
	var err error
...
func (service *Service) buildRuleInGroup(obj *v1alpha1.SecurityPolicy, rule *v1alpha1.SecurityPolicyRule, nsxRule *model.Rule, ruleIdx int) (*model.Group, string, string, error) {
	var nsxRuleSrcGroup *model.Group
	var nsxRuleSrcGroupPath string
	var nsxRuleDstGroupPath string
	var err error
...
func (service *Service) buildRuleOutGroup(obj *v1alpha1.SecurityPolicy, rule *v1alpha1.SecurityPolicyRule, nsxRule *model.Rule, ruleIdx int) (*model.Group, string, string, error) {
	var nsxRuleDstGroup *model.Group
	var nsxRuleSrcGroupPath string
	var nsxRuleDstGroupPath string
	var err error
...
func (service Service) buildRuleID(obj *v1alpha1.SecurityPolicy, idx int) string {
	return fmt.Sprintf("sp_%s_%d", obj.UID, idx)
}

func (service *Service) buildRuleName(obj *v1alpha1.SecurityPolicy, rule *v1alpha1.SecurityPolicyRule, idx int) string {
	if len(rule.Name) > 0 {
		return rule.Name
	} else {
...
func (service *Service) buildRuleAppliedGroupByPolicy(obj *v1alpha1.SecurityPolicy, nsxRuleSrcGroupPath string, nsxRuleDstGroupPath string) (string, error) {
	var nsxRuleAppliedGroupPath string
...
func (service Service) buildRuleAppliedGroupByRule(obj *v1alpha1.SecurityPolicy, rule *v1alpha1.SecurityPolicyRule, idx int) (*model.Group, string, error) {
	...
	ruleAppliedGroupPath := fmt.Sprintf("/infra/domains/%s/groups/%s", service.NSXConfig.Cluster, ruleAppliedGroupID)
...
func (service Service) buildRuleSrcGroup(obj *v1alpha1.SecurityPolicy, rule *v1alpha1.SecurityPolicyRule, idx int) (*model.Group, string, error) {
	...
	ruleSrcGroupPath := fmt.Sprintf("/infra/domains/%s/groups/%s", service.NSXConfig.Cluster, ruleSrcGroupID)
...
func (service Service) buildRuleDstGroup(obj *v1alpha1.SecurityPolicy, rule *v1alpha1.SecurityPolicyRule, idx int) (*model.Group, string, error) {
	...
	ruleDstGroupPath := fmt.Sprintf("/infra/domains/%s/groups/%s", service.NSXConfig.Cluster, ruleDstGroupID)
...
func (service *Service) buildRuleBasicInfo(obj *v1alpha1.SecurityPolicy, rule *v1alpha1.SecurityPolicyRule, ruleIdx int, portIdx int, portAddressIdx int) (*model.Rule, error) {
...
func (service *Service) BuildPeerTags(obj *v1alpha1.SecurityPolicy, peers *[]v1alpha1.SecurityPolicyPeer, idx int) []model.Tag {
...
func (service *Service) updateTargetExpressions(obj *v1alpha1.SecurityPolicy, target *v1alpha1.SecurityPolicyTarget, group *model.Group,
	idx int) (int, int, error) {
	var err error = nil
	...
	clusterExpression := service.buildExpression(
		"Condition", "Segment",
		fmt.Sprintf("%s|%s", util.TagScopeNCPCluster, service.NSXConfig.Cluster),
		"Tag", "EQUALS", "EQUALS",
	)
...
func (service Service) appendOperatorIfNeeded(policyExpression *[]*data.StructValue, op string) {
...
func (service Service) addOperatorIfNeeded(expressions *data.ListValue, op string) {
...
func (service Service) updateExpressionsMatchLabels(matchLabels map[string]string, memberType string, expressions *data.ListValue) {
...
func (service Service) mergeSelectorMatchExpression(matchExpressions []v1.LabelSelectorRequirement) *[]v1.LabelSelectorRequirement {
...
func (service *Service) validateSelectorOpIn(matchExpressions []v1.LabelSelectorRequirement, matchLabels map[string]string) (int, error) {
	mexprInOpCount := 0
	mexprInValueCount := 0
	var err error = nil
	errorMsg := ""
...
func (service Service) validateNsSelectorOpNotIn(nsMatchExpressions []v1.LabelSelectorRequirement) error {
	var err error = nil
	errorMsg := ""
...
func (service *Service) validateSelectorExpressions(matchLabelsCount int, matchExpressionsCount int, opInValueCount int, mixedCriteria bool) (int, int, error) {
	var err error = nil
	errorMsg := ""
	totalExprCount := 0
	totalCriteria := 0
...
// Todo, refactor code when NSX support 'In' LabelSelector.
func (service *Service) matchExpressionOpInExist(
...
func (service *Service) updateExpressionsMatchExpression(matchExpressions []v1.LabelSelectorRequirement, matchLabels map[string]string,
...
func (service *Service) updateMixedExpressionsMatchExpression(nsMatchExpressions []v1.LabelSelectorRequirement,
...
func (service Service) updatePeerExpressions(obj *v1alpha1.SecurityPolicy, peer *v1alpha1.SecurityPolicyPeer, group *model.Group, idx int) (int, int, error) {
	var err error = nil
	errorMsg := ""
	var tagValueExpression *data.StructValue = nil
