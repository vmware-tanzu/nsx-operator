...
func TestBuildRuleDisplayName(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			ruleIdx:                 0,
			createdFor:              common.ResourceTypeSecurityPolicy,
			namedPort:               newNamedPortInfoByAddressPort(nsxutil.PortAddress{Port: 80}, "TCP"),
		...
		},
		{
			...
			ruleIdx:                 1,
			createdFor:              common.ResourceTypeSecurityPolicy,
			namedPort:               newNamedPortInfoByAddressPort(nsxutil.PortAddress{Port: 443}, "TCP"),
