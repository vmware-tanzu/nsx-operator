...
func TestExpandRule(t *testing.T) {
	...
	spRuleTags := ruleTagsFn("security_policy_cr")
	...
	mockVPCService := common.MockVPCServiceProvider{VPCResource: &common.VPCResourceInfo{
		OrgID:     "default",
		ProjectID: "pro1",
		VPCID:     "vpc1",
	}}
	mockVPCService.On("ListVPCInfo", mock.Anything).Return(nil).Maybe()
	...
	for _, tc := range []struct {
	...
	}{
		{
			...
			name:       "T1: rule without and ports for NetworkPolicy",
			vpcEnabled: false,
			ruleIdx:    0,
			createdFor: common.ResourceTypeNetworkPolicy,
			expRules: []*model.Rule{
				{
					Id:             common.String("np_uid1_26e848bd5724c09acc141b8c30b05d59533e694b_0_0_0"),
					DisplayName:    common.String("rule1"),
					Direction:      common.String(string("IN")),
					SequenceNumber: Int64(int64(0)),
					Action:         common.String(string("ALLOW")),
			...
			name:       "T1: named rule without named ports for NetworkPolicy",
			vpcEnabled: false,
			ruleIdx:    1,
			createdFor: common.ResourceTypeNetworkPolicy,
			expRules: []*model.Rule{
				{
					Id:             common.String("np_uid1_2a54787ab7a813c379d67051283b4de550d38360_1_0_0"),
					DisplayName:    common.String("rule2"),
					Direction:      common.String(string("IN")),
					SequenceNumber: Int64(int64(1)),
					Action:         common.String(string("ALLOW")),
			...
			name:       "T1: rule with named ports for NetworkPolicy",
			vpcEnabled: false,
			ruleIdx:    2,
			createdFor: common.ResourceTypeNetworkPolicy,
			expGroups: []*model.Group{
				getTestIPsetGroup("np_uid1_94b44028488f3e719879abbc27c75e5cb44872b7_2_0_0_ipset", "TCP.http_UDP.1236.1237.TCP.8080_ingress_allow_ipset", "np_uid1_94b44028488f3e719879abbc27c75e5cb44872b7_2", false, "network_policy"),
			},
			expRules: []*model.Rule{
				{
					Id:                common.String("np_uid1_94b44028488f3e719879abbc27c75e5cb44872b7_2_0_0"),
					DisplayName:       common.String("TCP.http_UDP.1236.1237.TCP.8080_ingress_allow"),
					Direction:         common.String("IN"),
					SequenceNumber:    Int64(int64(2)),
					Action:            common.String("ALLOW"),
					...
					ServiceEntries:    []*data.StructValue{getRuleServiceEntries(8080, 0, "TCP")},
					Tags:              npRuleTags,
					DestinationGroups: []string{"/infra/domains//groups/np_uid1_94b44028488f3e719879abbc27c75e5cb44872b7_2_0_0_ipset"},
				}, {
					Id:             common.String("np_uid1_94b44028488f3e719879abbc27c75e5cb44872b7_2_1_0"),
					DisplayName:    common.String("TCP.http_UDP.1236.1237.UDP.1236.1237_ingress_allow"),
					Direction:      common.String("IN"),
					SequenceNumber: Int64(int64(2)),
					Action:         common.String("ALLOW"),
			...
			expGroups: []*model.Group{
				getTestIPsetGroup("p1_uid1_94b44028_8080_ipset", "TCP.http_UDP.1236.1237.TCP.8080_ingress_allow_ipset", "p1_uid1_94b44028", true, "security_policy_cr"),
			},
			expRules: []*model.Rule{
				{
					Id:                common.String("p1_uid1_94b44028_8080"),
