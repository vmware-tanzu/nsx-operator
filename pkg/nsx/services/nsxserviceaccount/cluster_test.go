		...
		},
		{
			...
			expectedCR: &v1alpha1.NSXServiceAccount{
				...
				Status: v1alpha1.NSXServiceAccountStatus{
					...
					SupervisorClusterName: "k8scl-one:1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890",
					Secrets:               []v1alpha1.NSXSecret{{Name: "name1-nsx-cert", Namespace: "ns1"}},
				},
			},
		},
