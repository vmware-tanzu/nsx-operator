...
func getRuleDirection(rule *v1alpha1.SecurityPolicyRule) (string, error) {
	...
	if ruleDirection == util.ToUpper(v1alpha1.RuleDirectionIngress) ||
		ruleDirection == util.ToUpper(v1alpha1.RuleDirectionIn) {
		return "IN", nil
	} else if ruleDirection == util.ToUpper(v1alpha1.RuleDirectionEgress) ||
		ruleDirection == util.ToUpper(v1alpha1.RuleDirectionOut) {
		return "OUT", nil
	}
