...
const (
	...
	LabelDefaultNetwork                string = "nsx.vmware.com/default-network"
	...
	DefaultVMNetwork                   string = "vm"
	DefaultPodNetwork                  string = "pod"
	...
	AnnotationIPAllocLB                string = "nsx.vmware.com/lb"
	AnnotationIPAllocReuseVIP          string = "nsx.vmware.com/reuse-vip"
	TagScopeIPAllocLB                  string = "nsx-op/lb"
