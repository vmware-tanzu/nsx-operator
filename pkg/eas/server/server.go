...
type EASServer struct {
	...
	vpcServiceEndpointStats *storage.VPCServiceEndpointStatisticsStorage
...
func NewEASServer(
	...
	return &EASServer{
		...
		vpcServiceEndpointStats: storage.NewVPCServiceEndpointStatisticsStorage(nsxClient, vpcProvider),
...
func (s *EASServer) buildGenericAPIServer() (*genericapiserver.GenericAPIServer, error) {
	...
	apiGroupInfo.VersionedResourcesStorageMap[easv1alpha1.GroupVersion.Version] = map[string]apirest.Storage{
		...
		"vpcserviceendpointstatistics": rest.NewVPCServiceEndpointStatisticsREST(s.vpcServiceEndpointStats),
	}
