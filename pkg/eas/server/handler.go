...
func (s *EASServer) initHandlers() {
	...
	registerResource(s, "ipblockusages", resourceOps[easv1alpha1.IPBlockUsage, easv1alpha1.IPBlockUsageList]{
		...
		toRow: func(item *easv1alpha1.IPBlockUsage) metav1.TableRow {
			return tableRow(item.Name, item.Namespace, ipBlockRangesSummary(item.UsedIPRanges), ipBlockRangesSummary(item.AvailableIPRanges))
		},
	...
	registerResource(s, "subnetdhcpserverstats", resourceOps[easv1alpha1.SubnetDHCPServerStats, easv1alpha1.SubnetDHCPServerStatsList]{
		kind: "SubnetDHCPServerStats",
		get:  s.subnetDHCPStats.Get, list: s.subnetDHCPStats.List,
		items: func(l *easv1alpha1.SubnetDHCPServerStatsList) *[]easv1alpha1.SubnetDHCPServerStats {
			return &l.Items
		},
		newList: func() *easv1alpha1.SubnetDHCPServerStatsList {
			return &easv1alpha1.SubnetDHCPServerStatsList{TypeMeta: easListTypeMeta("SubnetDHCPServerStatsList")}
		},
		columns: subnetDHCPColumns,
		toRow: func(item *easv1alpha1.SubnetDHCPServerStats) metav1.TableRow {
			return tableRow(item.Name, item.Namespace, subnetDHCPStatsSummary(item))
		},
		getName: func(item *easv1alpha1.SubnetDHCPServerStats) string { return item.Name },
	})
}
