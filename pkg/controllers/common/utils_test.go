...
func TestValidateIPBlockNamesTransition(t *testing.T) {
	tests := []struct {
		name      string
		oldBlocks []string
		newBlocks []string
		...
		{
			name:      "No change in IP block names",
			oldBlocks: []string{":block-1"},
			newBlocks: []string{":block-1"},
			oldType:   v1alpha1.IPAddressTypeIPv4,
			newType:   v1alpha1.IPAddressTypeIPv4,
			wantErr:   "",
		},
		{
			name:      "Both empty IP block names",
			oldBlocks: nil,
			newBlocks: nil,
			oldType:   v1alpha1.IPAddressTypeIPv4,
			newType:   v1alpha1.IPAddressTypeIPv4,
		...
		{
			name:      "IPv4 to IPv4IPv6 transition with valid IP block added",
			oldBlocks: []string{":block-1"},
			newBlocks: []string{":block-1", ":block-2"},
			oldType:   v1alpha1.IPAddressTypeIPv4,
			newType:   v1alpha1.IPAddressTypeIPv4IPv6,
			wantErr:   "",
		},
		{
			name:      "IPv6 to IPv4IPv6 transition with valid IP block added",
			oldBlocks: []string{":block-1"},
			newBlocks: []string{":block-1", ":block-2"},
			oldType:   v1alpha1.IPAddressTypeIPv6,
			newType:   v1alpha1.IPAddressTypeIPv4IPv6,
		...
		{
			name:      "IPv4 to IPv4IPv6 transition from empty IP block names",
			oldBlocks: nil,
			newBlocks: []string{":block-1"},
			oldType:   v1alpha1.IPAddressTypeIPv4,
			newType:   v1alpha1.IPAddressTypeIPv4IPv6,
		...
		{
			name:      "Existing IP block name removed",
			oldBlocks: []string{":block-1"},
			newBlocks: []string{":block-2"},
			oldType:   v1alpha1.IPAddressTypeIPv4,
			newType:   v1alpha1.IPAddressTypeIPv4IPv6,
			wantErr:   "existing ipBlockNames cannot be removed or modified",
		},
		{
			name:      "Existing IP block name modified",
			oldBlocks: []string{":block-1"},
			newBlocks: []string{":block-1-modified", ":block-2"},
			oldType:   v1alpha1.IPAddressTypeIPv4,
			newType:   v1alpha1.IPAddressTypeIPv4IPv6,
			wantErr:   "existing ipBlockNames cannot be removed or modified",
		},
		{
			name:      "IP block names changed without IPAddressType transition to IPv4IPv6",
			oldBlocks: []string{":block-1"},
			newBlocks: []string{":block-1", ":block-2"},
			oldType:   v1alpha1.IPAddressTypeIPv4,
			newType:   v1alpha1.IPAddressTypeIPv4,
			wantErr:   "ipBlockNames can only be updated when ipAddressType transitions from IPv4 or IPv6 to IPv4IPv6",
		},
	}

	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			err := ValidateIPBlockNamesTransition(tt.oldBlocks, tt.newBlocks, tt.oldType, tt.newType)
			if tt.wantErr == "" {
				assert.NoError(t, err)
			} else {
				assert.EqualError(t, err, tt.wantErr)
