...
func (r *SubnetReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if subnetCR.Spec.AccessMode == "" {
		...
		if err != nil {
			r.StatusUpdater.UpdateFail(ctx, subnetCR, err, "Failed to get default access mode", setSubnetReadyStatusFalse)
	...
	if util.SubnetFamilyUsesIPv6(subnetCR.Spec.IPAddressType) && subnetCR.Spec.IPv6PrefixLength == 0 {
...
func (r *SubnetReconciler) setDefaultIPv4SubnetSizeValue(ctx context.Context, subnetCR *v1alpha1.Subnet, vpcNetworkConfig *v1alpha1.VPCNetworkConfiguration) error {
	...
	if vpcNetworkConfig == nil {
		...
		if err != nil {
			log.Error(err, "Failed to set default subnet size", "Namespace", subnetCR.Namespace)
...
func (r *SubnetReconciler) setDefaultIPv6PrefixLengthValue(ctx context.Context, subnetCR *v1alpha1.Subnet, vpcNetworkConfig *v1alpha1.VPCNetworkConfiguration) error {
	...
	subnetCR.Spec.IPv6PrefixLength = util.EffectiveDefaultIPv6PrefixLength(vpcNetworkConfig.Spec)
	return nil
}
