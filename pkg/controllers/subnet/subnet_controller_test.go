	...
	testCases := []struct {
		...
		},
		{
			...
			patches: func(r *SubnetReconciler) *gomonkey.Patches {
				...
				patches.ApplyMethod(reflect.TypeOf(r.SubnetService), "IsDefaultNSXProject", func(_ *subnet.SubnetService, orgID, projectID string) (bool, error) {
					return false, nil
				})
				return patches
			},
			...
			subnetCR := &v1alpha1.Subnet{
				ObjectMeta: metav1.ObjectMeta{
					...
					Labels: map[string]string{
						common.LabelAssociatedResource: tt.associatedResource,
					},
				},
				Spec: v1alpha1.SubnetSpec{},
			}
