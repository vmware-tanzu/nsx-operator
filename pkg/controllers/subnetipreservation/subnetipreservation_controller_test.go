	...
	tests := []struct {
		...
		},
		{
			...
			preparedFunc: func(r *Reconciler) *gomonkey.Patches {
				...
				patches.ApplyMethod(reflect.TypeOf(r.IPReservationService), "CreateOrUpdateSubnetIPReservation", func(_ *subnetipreservation.IPReservationService, ipReservation *v1alpha1.SubnetIPReservation, subnetPath string) (*model.DynamicIpAddressReservation, error) {
