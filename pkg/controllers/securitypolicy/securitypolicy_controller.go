...
func (r *SecurityPolicyReconciler) mergeSecurityPolicyStatusCondition(_ *context.Context, sec_policy *v1alpha1.SecurityPolicy, newCondition *v1alpha1.Condition) bool {
