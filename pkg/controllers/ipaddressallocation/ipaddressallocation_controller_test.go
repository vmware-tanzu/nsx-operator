...
func TestSetupWithManager(t *testing.T) {
	...
	// Create an instance of IPAddressAllocationReconciler
	reconciler := &IPAddressAllocationReconciler{}
	...
	updateEvent := event.UpdateEvent{
		ObjectOld: &v1alpha1.IPAddressAllocation{ObjectMeta: metav1.ObjectMeta{Generation: 1}},
		ObjectNew: &v1alpha1.IPAddressAllocation{ObjectMeta: metav1.ObjectMeta{Generation: 2}},
	}
	...
	assert.True(t, pred.Update(updateEvent))
	assert.False(t, pred.Delete(deleteEvent))
