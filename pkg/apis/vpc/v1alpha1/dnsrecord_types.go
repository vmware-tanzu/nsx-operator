...
type DNSRecordSpec struct {
	...
	// IPAddress is the IP address being mapped by a PTR record.
	// Only applicable when RecordType is PTR.
	// +optional
	...
	// FQDN is the system-computed fully qualified domain name.
	// This field is read-only and must not be set in create or update requests.
	// Formed by combining RecordName with DomainName.
	// +optional
