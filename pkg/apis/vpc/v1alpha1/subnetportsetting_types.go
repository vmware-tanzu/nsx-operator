...
type SubnetPortSettingSpec struct {
	// SubnetName defines the Subnet name of the SubnetPortSetting.
...
// +kubebuilder:printcolumn:name="SubnetName",type=string,JSONPath=`.spec.subnetName`,description="Subnet name of the SubnetPortSetting."
