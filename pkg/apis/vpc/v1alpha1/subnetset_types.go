...
// +kubebuilder:validation:XValidation:rule="!has(oldSelf.ipv6SubnetMask) || has(self.ipv6SubnetMask)", message="ipv6SubnetMask is required once set"
...
// +kubebuilder:printcolumn:name="IPv6SubnetMask",type=string,JSONPath=`.spec.ipv6SubnetMask`,description="Prefix length of IPv6 Subnet"
