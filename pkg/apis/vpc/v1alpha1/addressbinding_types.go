...
type AddressBindingSpec struct {
	...
	// ExternalIPAddressAllocation contains name of the external IP address allocation CR.
	ExternalIPAddressAllocation string `json:"externalIPAddressAllocation,omitempty"`
}
