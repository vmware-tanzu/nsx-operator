...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/vmware-tanzu/nsx-operator/pkg/apis/eas/v1alpha1.ServiceEndpointStatistics":     schema_pkg_apis_eas_v1alpha1_ServiceEndpointStatistics(ref),
		"github.com/vmware-tanzu/nsx-operator/pkg/apis/eas/v1alpha1.ServiceEndpointStatisticsList": schema_pkg_apis_eas_v1alpha1_ServiceEndpointStatisticsList(ref),
...
func schema_pkg_apis_eas_v1alpha1_AllocatedByVPC(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"ipAddresses": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "IPAddresses contains CIDR and subnet or IP address allocation.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/vmware-tanzu/nsx-operator/pkg/apis/eas/v1alpha1.VPCIPAddress"),
									},
								},
							},
						},
					...
					"accessMode": {
						SchemaProps: spec.SchemaProps{
							Description: "Access mode of the subnet allocated from the IP Block. Must be Public, PrivateTGW or Private.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
		...
		Dependencies: []string{
			"github.com/vmware-tanzu/nsx-operator/pkg/apis/eas/v1alpha1.VPCIPAddress"},
	}
}

func schema_pkg_apis_eas_v1alpha1_CIDRUsage(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Represents used and available IP statistics for CIDRs in an IPBlock.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"cidr": {
						SchemaProps: spec.SchemaProps{
					...
					"usageDetails": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/vmware-tanzu/nsx-operator/pkg/apis/eas/v1alpha1.UsageDetails"),
						},
					},
				},
			},
...
func schema_pkg_apis_eas_v1alpha1_DHCPIPPoolUsage(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_eas_v1alpha1_IPBlockUsage(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/vmware-tanzu/nsx-operator/pkg/apis/eas/v1alpha1.CIDRUsage"),
									},
								},
							},
						},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/vmware-tanzu/nsx-operator/pkg/apis/eas/v1alpha1.RangeUsage"),
									},
								},
							},
						},
					...
					"visibility": {
						SchemaProps: spec.SchemaProps{
							Description: "Visibility of IPBlock. Must be External or Private.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
		...
		Dependencies: []string{
			"github.com/vmware-tanzu/nsx-operator/pkg/apis/eas/v1alpha1.CIDRUsage", "github.com/vmware-tanzu/nsx-operator/pkg/apis/eas/v1alpha1.RangeUsage", v1.ObjectMeta{}.OpenAPIModelName()},
	}
}

func schema_pkg_apis_eas_v1alpha1_IPBlockUsageList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "IPBlockUsageList contains a list of IPBlockUsage.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/vmware-tanzu/nsx-operator/pkg/apis/eas/v1alpha1.IPBlockUsage"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/vmware-tanzu/nsx-operator/pkg/apis/eas/v1alpha1.IPBlockUsage", v1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_pkg_apis_eas_v1alpha1_IPPoolRange(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"start": {
						SchemaProps: spec.SchemaProps{
							Description: "The start IP Address of the IP range. format: IP.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"end": {
						SchemaProps: spec.SchemaProps{
							Description: "The end IP Address of the IP range. format: IP.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
...
func schema_pkg_apis_eas_v1alpha1_PoolUsage(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_eas_v1alpha1_RangeUsage(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Represents used and available IP statistics for IP ranges in an IPBlock.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"range": {
						SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_eas_v1alpha1_SubnetDHCPServerStats(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SubnetDHCPServerStats exposes the Subnet's DHCP server statistics. The SubnetDHCPServerStats name should be the same as the Subnet CR name.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/vmware-tanzu/nsx-operator/pkg/apis/eas/v1alpha1.DHCPIPPoolUsage", v1.ObjectMeta{}.OpenAPIModelName()},
	}
}

func schema_pkg_apis_eas_v1alpha1_SubnetDHCPServerStatsList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SubnetDHCPServerStatsList contains a list of SubnetDHCPServerStats.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/vmware-tanzu/nsx-operator/pkg/apis/eas/v1alpha1.SubnetDHCPServerStats"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/vmware-tanzu/nsx-operator/pkg/apis/eas/v1alpha1.SubnetDHCPServerStats", v1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_pkg_apis_eas_v1alpha1_SubnetIPPools(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SubnetIPPools describes IP pools of a Subnet. The SubnetIPPools name is the same as subnet CR name.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"ipAddressType": {
						SchemaProps: spec.SchemaProps{
							Description: "Type of IP address. Must be IPv4 or IPv6.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"poolUsage": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/vmware-tanzu/nsx-operator/pkg/apis/eas/v1alpha1.PoolUsage"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/vmware-tanzu/nsx-operator/pkg/apis/eas/v1alpha1.PoolUsage", v1.ObjectMeta{}.OpenAPIModelName()},
	}
}

func schema_pkg_apis_eas_v1alpha1_SubnetIPPoolsList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SubnetIPPoolsList contains a list of SubnetIPPools.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/vmware-tanzu/nsx-operator/pkg/apis/eas/v1alpha1.SubnetIPPools"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/vmware-tanzu/nsx-operator/pkg/apis/eas/v1alpha1.SubnetIPPools", v1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_pkg_apis_eas_v1alpha1_UsageDetails(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					"usedIPRanges": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "Represents IP ranges that are allocated from the CIDR or IP range in the org scope.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"overallUsedIPRanges": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "Represents the overall IP ranges allocated from the CIDR or IP range across all orgs.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_eas_v1alpha1_VPCIPAddress(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"subnetName": {
						SchemaProps: spec.SchemaProps{
							Description: "The name of the Subnet to which the IP address is allocated. Only one of subnetName and ipAddressAllocationName will be set.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"ipAddressAllocationName": {
						SchemaProps: spec.SchemaProps{
							Description: "The name of the IPAddressAllocation to which the IP address is allocated. Only one of subnetName and ipAddressAllocationName will be set.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_pkg_apis_eas_v1alpha1_VPCIPAddressBlock(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"cidr": {
						SchemaProps: spec.SchemaProps{
							Description: "CIDR address for IPBlock. Deprecated: Use CIDRs instead.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					...
					"ranges": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "The list of IP address ranges in the form of start and end IPs.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/vmware-tanzu/nsx-operator/pkg/apis/eas/v1alpha1.IPPoolRange"),
									},
								},
							},
						},
					...
					"excludedIPs": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "The list of excluded IP address in the form of start and end IPs.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/vmware-tanzu/nsx-operator/pkg/apis/eas/v1alpha1.AllocatedByVPC", "github.com/vmware-tanzu/nsx-operator/pkg/apis/eas/v1alpha1.IPPoolRange"},
	}
}

func schema_pkg_apis_eas_v1alpha1_VPCIPAddressUsage(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "VPCIPAddressUsage is the usage information for IP addresses within a specific VPC. This information provides insights into the allocation and utilization of IP addresses by the VPC and its subnets.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/vmware-tanzu/nsx-operator/pkg/apis/eas/v1alpha1.VPCIPAddressBlock"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/vmware-tanzu/nsx-operator/pkg/apis/eas/v1alpha1.VPCIPAddressBlock", v1.ObjectMeta{}.OpenAPIModelName()},
	}
}

func schema_pkg_apis_eas_v1alpha1_VPCIPAddressUsageList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "VPCIPAddressUsageList contains a list of VPCIPAddressUsage.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/vmware-tanzu/nsx-operator/pkg/apis/eas/v1alpha1.VPCIPAddressUsage"),
									},
								},
							},
						},
...
func schema_pkg_apis_eas_v1alpha1_ServiceEndpointStatistics(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ServiceEndpointStatistics describes the statistics of a VPC Service Endpoint.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_eas_v1alpha1_ServiceEndpointStatisticsList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ServiceEndpointStatisticsList contains a list of ServiceEndpointStatistics.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/vmware-tanzu/nsx-operator/pkg/apis/eas/v1alpha1.ServiceEndpointStatistics"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/vmware-tanzu/nsx-operator/pkg/apis/eas/v1alpha1.ServiceEndpointStatistics", v1.ListMeta{}.OpenAPIModelName()},
	}
}
