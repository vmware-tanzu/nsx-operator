...
import (
	v1alpha1 "github.com/vmware-tanzu/nsx-operator/pkg/client/clientset/versioned/typed/crd.nsx.vmware.com/v1alpha1"
...
func (c *FakeCrdV1alpha1) IPPools(namespace string) v1alpha1.IPPoolInterface {
