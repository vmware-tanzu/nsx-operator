...
// SubnetConnectionBindingMapInformer provides access to a shared informer and lister for
...
// NewSubnetConnectionBindingMapInformer constructs a new informer for SubnetConnectionBindingMap type.
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewSubnetConnectionBindingMapInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
	return NewFilteredSubnetConnectionBindingMapInformer(client, namespace, resyncPeriod, indexers, nil)
}

// NewFilteredSubnetConnectionBindingMapInformer constructs a new informer for SubnetConnectionBindingMap type.
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
...
func (f *subnetConnectionBindingMapInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewFilteredSubnetConnectionBindingMapInformer(client, f.namespace, resyncPeriod, cache.Indexers{cache.NamespaceIndex: cache.MetaNamespaceIndexFunc}, f.tweakListOptions)
}
