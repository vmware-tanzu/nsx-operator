...
type VPCEndpointInformer interface {
	...
	Lister() vpcv1alpha1.VPCEndpointLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CrdV1alpha1().VPCEndpoints(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CrdV1alpha1().VPCEndpoints(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CrdV1alpha1().VPCEndpoints(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CrdV1alpha1().VPCEndpoints(namespace).Watch(ctx, options)
			},
		}, client),
		&apisvpcv1alpha1.VPCEndpoint{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *vPCEndpointInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisvpcv1alpha1.VPCEndpoint{}, f.defaultInformer)
}

func (f *vPCEndpointInformer) Lister() vpcv1alpha1.VPCEndpointLister {
	return vpcv1alpha1.NewVPCEndpointLister(f.Informer().GetIndexer())
}
