...
import (
	...
	crdnsxvmwarecomv1alpha2 "github.com/vmware-tanzu/nsx-operator/pkg/apis/crd.nsx.vmware.com/v1alpha2"
	...
	v1alpha2 "github.com/vmware-tanzu/nsx-operator/pkg/client/listers/crd.nsx.vmware.com/v1alpha2"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CrdV1alpha2().IPPools(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CrdV1alpha2().IPPools(namespace).Watch(context.TODO(), options)
			},
		},
		&crdnsxvmwarecomv1alpha2.IPPool{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *iPPoolInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&crdnsxvmwarecomv1alpha2.IPPool{}, f.defaultInformer)
}
