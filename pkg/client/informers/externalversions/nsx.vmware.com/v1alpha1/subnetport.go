	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NsxV1alpha1().SubnetPorts(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NsxV1alpha1().SubnetPorts(namespace).Watch(context.TODO(), options)
			},
		},
		&nsxvmwarecomv1alpha1.SubnetPort{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *subnetPortInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&nsxvmwarecomv1alpha1.SubnetPort{}, f.defaultInformer)
}
